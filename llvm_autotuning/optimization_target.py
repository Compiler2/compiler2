...
# TODO: We should find a way to install our session with setuptool.
...
class OptimizationTarget(str, Enum):
    ...
    def make_env(self, benchmark: Union[str, Benchmark]) -> LlvmEnv:
        ...
        # Instantiate out compilation session
        # import gym
        # env = gym.make("perf-v0")
        env = compiler_gym.make("perf-v0")
