...
int main_bench()
{
	...
	struct reward a[2];
	my_scanf("%d",&n);
	my_scanf("%s%d%d%s%s%d",a[0].name,&a[0].score,&a[0].comment,a[0].boss,a[0].west,&a[0].paper);
	...
	{
		my_scanf("%s%d%d%s%s%d",a[1].name,&a[1].score,&a[1].comment,a[1].boss,a[1].west,&a[1].paper);
