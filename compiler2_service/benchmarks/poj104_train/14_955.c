...
my_scanf("%d %d %d",&top1->id,&top1->chn,&top1->mth);
top1->total=top1->chn + top1->mth;
my_scanf("%d %d %d",&top2->id,&top2->chn,&top2->mth);
...
my_scanf("%d %d %d",&top3->id,&top3->chn,&top3->mth);
...
my_scanf("%d %d %d",&p1->id,&p1->chn,&p1->mth);
