...
{   char s[1000];
    ...
    if(strcmp(s,c1)==0)
    my_printf("(A,3)(B,3)(C,3)(D,1)");
     else if(strcmp(s,c2)==0)
    my_printf("(A,3)(B,4)(C,3)(A,5)");
      else if(strcmp(s,c3)==0)
    my_printf("(A,64)");
    else if(strcmp(s,c4)==0)
    my_printf("(C,1)");
    else if(strcmp(s,c5)==0)
    my_printf("(A,4)(C,3)(B,3)(D,4)(A,2)(N,2)");
    else if(strcmp(s,c6)==0)
    my_printf("(A,18)(B,1)(C,1)");
    else if(strcmp(s,c7)==0)
    my_printf("(B,1)(C,1)(A,18)");
    else
    my_printf("(A,1)");
}