...
def submit_job():
    ...
    command = f"python -u {args.app} --ray-mode=slurm --iter={args.iter} --stop_reward={args.stop_reward} --wandb_url={args.wandb_url} --trainer={args.trainer} --dataset={args.dataset} --size={args.size} --eval_size={args.eval_size} --eval_time={args.eval_time} --network={args.network} --steps={args.steps} --sweep={args.sweep}" 
